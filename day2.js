...
sayHello(function Hi(){console.log("okay");});
...
UserDetails.call(user2, "prepbytes", "Backend Developer");
...
UserDetails.apply(user2, ["prepbytes", " Full Stack Developer"]);
...
newFunction("prepbytes", "Data Scientist")
...
const students1 = new Students('Abhishek',23,'male');
...
const personNew = new PersonTwo('Goldy','Monitoring',1999)
const personNew1 = new PersonThree('Veeru');
