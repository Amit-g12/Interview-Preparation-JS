...
//Async/await is basically used to ignore promises.
...
//Declaration part is hoisted only not initialization.
...
//This is a function which gives you same output for the same input passed everytime.It doesn't give differenct output for the same input everytime we call the functions.It doesn't depends on some variables whose value might change in the future, and therefore always gives u same values. 
...
//so, we therefore use aysnc  before the function name to return a promise instead of value.
...
//we can use them(async/await) for making API's calls.
